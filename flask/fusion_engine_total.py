...
"""
Fusion-based RecSys engine that uses full-sized (top_k=10000) rankings.
...
class FusionEngineTotal(FusionEngine):
    """
    Implement a combined retrieval engine using late fusion.
    """

    def retrieval(self, preferences, n=9, top_k=10000):
...
if __name__ == "__main__":
    ...
    eng = FusionEngineTotal(models=(lda, bert), model_weights=(0.50, 0.50))
